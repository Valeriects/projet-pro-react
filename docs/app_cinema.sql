...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : sam. 20 avr. 2024 à 19:26
...
INSERT INTO `media` (`id`, `src_img`, `alt_img`, `alt_video`, `src_video`, `movies_id`) VALUES
(1, 'pauvres-creatures.jpg', 'affiche du film pauvres créatures', 'bande-annonce de pauvre créature', 'https://www.youtube.com/embed/32vmnIuURCo?si=HprNr7Hl_a8b0FyZ', 1),
(2, 'borderlands-2024.jpg', 'affiche de borderlands 2024', 'BA de borderlands', 'https://www.youtube.com/embed/IF5Fq9wB-fQ?si=x7BEHJLJqQL-TevP', 9),
(4, 'Dune2.jpg', 'affiche de dune 2', 'Bande annonce dune 2', 'https://www.youtube.com/embed/kF1WyiTZFTk?si=KDfssPom0lCJBNio', 6),
(5, 'Madame-Web.jpg', 'affiche madame web', 'bande annonce madame web', 'https://www.youtube.com/embed/mZLJfwcP_pM?si=agpl3EoXwkFwuytm', 7),
(23, '18-04-2024_08H13_horizon.jpg', 'affiche horizon', 'lien bande annonce Horizon', 'https://www.youtube.com/embed/YYsReoZMj1k?si=xMg3PzuphEHgvmS5', 5),
(26, '18-04-2024_08H35_kung-fu-panda-4.jpg', 'affiche de kung-fu panda 4', 'lien bande annonce kung fu panda 4', 'https://www.youtube.com/embed/-5qyM5TSWuY?si=tFQrXpqYbFx7CwGb', 2),
(33, '17-04-2024_18H09_dernier-jaguar.jpg', 'affiche le dernierjaguar', 'Lien vidéo le dernier jaguar', 'https://www.youtube.com/embed/G9AgInuQ2KI?si=zB4z9FYxIXK1iIox', 8);
...
(1, 'Pauvres Créatures', '2024-01-13', 'Bella est une jeune femme ramenée à la vie par le brillant et peu orthodoxe Dr Godwin Baxter. Sous sa protection, elle a soif d\'apprendre. Avide de découvrir le monde dont elle ignore tout, elle s\'enfuit avec Duncan Wedderburn, un avocat habile et débauché, et embarque pour une odyssée étourdissante à travers les continents. Imperméable aux préjugés de son époque, Bella est résolue à ne rien céder sur les principes d\'égalité et de libération.', ' Yorgos Lanthimos', '02:21:00', 'Emma Stone, Mark Ruffalo, Willem Dafoe'),
...
(10, 'admin', 'Administrator', '$2b$10$ArrX9WFp3I03L4LDPpm.OeUEbHoJQxxSU8PyHMMoYIEbhdqTrrNQS', '22, avenue des admin 34000 Montpellier', 'admin2@gmail.com', 750869522, '1980-04-22', '2024-02-11 19:55:48', '2024-04-20 20:59:00', 1),
...
(30, 'Pomme', 'Neuf', '$2b$10$X64i4Avidu6pm4DhjedWvOdhQ27gmILc2Ak9tp/ANwsGjC1PRVbTW', '552, avenue de la prairie 13100aix en provence', '9@gmail.com', 212325262, '2010-06-09', '2024-03-27 18:27:40', '2024-04-20 20:55:24', 2),
...
--
ALTER TABLE `media`
  ADD CONSTRAINT `FK_id_movies` FOREIGN KEY (`movies_id`) REFERENCES `movies` (`id`) ON UPDATE CASCADE;
